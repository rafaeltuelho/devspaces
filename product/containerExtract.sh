...
Examples:
  $0 quay.io/redhat_na_ssa/devspaces-operator-bundle:latest
  $0 quay.io/devworkspace/devworkspace-operator-bundle:next
  $0 quay.io/redhat_na_ssa/devfileregistry-rhel8:latest --tar-flags var/www/html/*/external_images.txt --arch ppc64le
